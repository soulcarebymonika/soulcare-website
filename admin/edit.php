...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($error)){
        $sql = "UPDATE blog_posts SET title=:title, slug=:slug, meta_title=:meta_title, meta_description=:meta_description, 
                category=:category, author=:author, image_alt=:image_alt, excerpt=:excerpt, content=:content, image_path=:image_path WHERE id=:id";
...
<head>
    ...
    <style>
        ...
        .btn { padding: 10px 15px; background: #007bff; color: #fff; border: none; border-radius: 4px; cursor: pointer; }
        ...
        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" enctype="multipart/form-data">
            ...
            <?php if(!empty($existing_image)): ?>
                <div class="current-image" style="margin-bottom: 20px;">
                    <img src="<?php echo htmlspecialchars($existing_image); ?>" width="150" alt="Current Image"><br>
